        ...
        <div class="flex flex-row justify-self-end">
          ...
          <div class="flex flex-col visible xl:hidden w-34" ref="menu">
            ...
            <div class="xl:hidden w-30 ml-4 text-sm tracking-bit" v-show="showMenu">
              ...
              <nuxt-link :to="`/research`" title="Research Section"
              ...
              <nuxt-link :to="`/projects`" title="Projects Section"
              ...
              <nuxt-link :to="`/awards`" title="Awards Section"
              ...
              <nuxt-link :to="`/publications`" title="Publications Section"
          ...
          <div class="hidden xl:flex text-sm tracking-bit">
            ...
            <div>
              <nuxt-link :to="`/research`" title="Research Section" class="mx-2.5 font-avenir color-corvid">Research</nuxt-link>
            </div>
            <div>
              <nuxt-link :to="`/projects`" title="Projects Section" class="mx-2.5 font-avenir color-corvid">Projects</nuxt-link>
            </div>
            <div>
              <nuxt-link :to="`/awards`" title="Awards Section" class="mx-2.5 font-avenir color-corvid">Awards</nuxt-link>
            </div>
            <div>
              <nuxt-link :to="`/publications`" title="Publications Section" class="mx-2.5 font-avenir color-corvid">Publications</nuxt-link>
            </div>
